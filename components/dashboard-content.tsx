...
export function DashboardContent() {
  ...
  return (
    <div className="p-6 space-y-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
        <MetricCard icon={Eye} iconColor="text-green-500" title="IMPRESSIONS" value={dashboardData.metrics.thisMonth.impressions.toLocaleString()} date="1 April 2026" />
        <MetricCard icon={MousePointer} iconColor="text-blue-500" title="CLICKS" value={dashboardData.metrics.thisMonth.clicks.toLocaleString()} date="1 April 2026" />
        <MetricCard icon={DollarSign} iconColor="text-green-500" title="ECPM" value={`$${dashboardData.metrics.thisMonth.ecpm.toFixed(2)}`} date="1 April 2026" />
        <MetricCard icon={BarChart2} iconColor="text-red-500" title="CTR" value={`${dashboardData.metrics.thisMonth.ctr.toFixed(2)}%`} date="1 April 2026" />
      </div>
      ...
      <div className="space-y-4">
        ...
        <Card className="p-4">
          <div className="grid grid-cols-1 md:grid-cols-5 gap-4 mb-6">
            <EarningsStat title="This Month" value={`$${dashboardData.metrics.thisMonth.revenue.toFixed(2)}`} date="1 April 2026" valueColor="text-green-500" />
            <EarningsStat title="Last Month" value={`$${dashboardData.metrics.lastMonth.revenue.toFixed(2)}`} />
            <EarningsStat title="Last 6 Months" value={`$${dashboardData.metrics.last6Months.revenue.toFixed(2)}`} date="1 April 2026" valueColor="text-blue-500" />
            <EarningsStat title="Total Clicks" value={dashboardData.metrics.thisMonth.clicks.toLocaleString()} date="1 April 2026" valueColor="text-blue-500" />
            <EarningsStat title="Impressions" value={dashboardData.metrics.thisMonth.impressions.toLocaleString()} date="1 April 2026" />
          </div>
