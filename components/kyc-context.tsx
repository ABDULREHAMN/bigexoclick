...
export function KycProvider({ children }: { children: ReactNode }) {
  const [kycStatus, setKycStatus] = useState<KycStatus>("verified") // Set to verified
  ...
  const [selectedDocumentType, setSelectedDocumentType] = useState<string | null>("driving-license")

  // KYC verification details
  const verificationDate = "June 29, 2025"
  const kycReference = "#KYC2025-JUNE29"
  const fullName = "Motorist Michael, Matthew"
