          ...
          <div className="bg-green-50 border border-green-200 rounded-lg p-4">
            ...
            <div className="space-y-3">
              ...
              <div className="flex items-center justify-between py-2 border-b border-green-100">
                ...
                <span className="text-sm text-gray-900 font-medium">Driving License</span>
              </div>
              <div className="flex items-center justify-between py-2 border-b border-green-100">
                <div className="flex items-center text-sm font-medium text-gray-700">
          ...
          <div className="bg-white border rounded-lg p-4">
            ...
            <div className="space-y-3">
              <div className="flex items-center justify-between py-2 border-b border-gray-100">
                ...
                <span className="text-xs text-gray-500">{verificationDate}</span>
              </div>
              <div className="flex items-center justify-between py-2 border-b border-gray-100">
                <div>
                  <p className="font-medium text-sm">Payment Method Added</p>
                  <p className="text-xs text-gray-500">USDT (BEP20) wallet configured</p>
                </div>
                <span className="text-xs text-gray-500">June 15, 2025</span>
              </div>
              <div className="flex items-center justify-between py-2 border-b border-gray-100">
                <div>
                  <p className="font-medium text-sm">Withdrawal Processed</p>
                  <p className="text-xs text-gray-500">$150.00 via PayPal</p>
                </div>
                <span className="text-xs text-gray-500">June 13, 2025</span>
              </div>
              <div className="flex items-center justify-between py-2">
                <div>
                  <p className="font-medium text-sm">Account Created</p>
                  <p className="text-xs text-gray-500">Welcome to EXOClick Publisher</p>
                </div>
                <span className="text-xs text-gray-500">{profileData.joinDate}</span>
              </div>
            </div>
          </div>
        </div>
